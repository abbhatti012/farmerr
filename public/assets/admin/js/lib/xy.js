            ...
            this.xAxes.each((e) => {
              if (e.get("zoomX")) {
                ...
                1 / (c - r) <
                  ...
                  this._handleWheelAnimation(e.zoom(r, c));
              }
            }),
            ("zoomX" !== i && "zoomXY" !== i) ||
              0 == r ||
              this.xAxes.each((e) => {
                if (e.get("zoomX")) {
                  ...
                  1 / (c - l) <
                    e.getPrivate("maxZoomFactor", 1 / 0) /
                      e.get("minZoomCount", 1) &&
                    this._handleWheelAnimation(e.zoom(l, c));
                }
              }),
            ("zoomY" !== t && "zoomXY" !== t) ||
              0 == l ||
              this.yAxes.each((e) => {
                if (e.get("zoomY")) {
                  ...
                  1 / (h - r) <
                    e.getPrivate("maxZoomFactor", 1 / 0) /
                      e.get("minZoomCount", 1) &&
                    this._handleWheelAnimation(e.zoom(r, h));
                }
              }),
            ("zoomY" !== i && "zoomXY" !== i) ||
              0 == r ||
              this.yAxes.each((e) => {
                if (e.get("zoomY")) {
                  ...
                  1 / (h - l) <
                    e.getPrivate("maxZoomFactor", 1 / 0) /
                      e.get("minZoomCount", 1) &&
                    this._handleWheelAnimation(e.zoom(l, h));
                }
              }),
            ("panX" !== t && "panXY" !== t) ||
              0 == l ||
        ...
        valueToPosition(e) {
          ...
          if (r.found) return (l - i) / a;
          {
            ...
            let s = t[l],
              o = 0;
            return (
              (o = s > e && e > this.getPrivate("min", 0) ? s - e : e - s),
        ...
        constructor() {
          super(...arguments),
            Object.defineProperty(this, "columns", {
              ...
              configurable: !0,
              writable: !0,
              value: new n.o(o.YS.new({ themeTags: ["autocolor"] }), () =>
                a.j._new(
                  this._root,
                  {
    ...
    3405: function (e, t, i) {
      ...
      class _ extends p {
        ...
        _prepareAxisItems() {
          ...
          b.getIntervalDuration(h) < this.baseDuration() &&
            (h = Object.assign({}, g));
          ...
          for (let e = i; e < s; e++) {
            ...
            "year" != h.timeUnit &&
              ...
              this.get("markUnitChange") &&
              d.isNumber(_) &&
              b.checkChange(a, _, c, this._root.utc) &&
        ...
        constructor() {
          super(...arguments),
            Object.defineProperty(this, "columns", {
              ...
              configurable: !0,
              writable: !0,
              value: new X.o(F.YS.new({ themeTags: ["autocolor"] }), () =>
                S._new(
                  this._root,
                  {
